            ...
            <div class="flex justify-between items-center px-4 py-3">
                <a href="/" class="main-logo flex items-center shrink-0">
                    <img class="w-8 ml-[5px] flex-none" src="/assets/images/logo.png"
                        alt="image" />
                    <span
                        class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle lg:inline dark:text-white-light">Trust Genie</span>
                </a>
                <a href="javascript:;"
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <a href="{{ route('dashboard') }}">
                    <li class="menu nav-item ">
                        <button type="button" class="nav-link {{ Request::is('dashboard') ? 'active' : '' }}" >
                ...
                <li class="nav-item">
                    <ul>
                        ...
                        {{-- Customer --}}
                        <li class="nav-item">
                            <a href="{{ route('customer.index') }}" class="group @if(Request::is('customer') || Request::is('customer/*')) active @endif">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Customer</span>
                                </div>
                            </a>
                        </li>
                        ...
                        {{-- Professional --}}
                        {{-- <li class="nav-item">
                            <a href="{{ route('professional.index') }}" class="group @if(Request::is('professional') || Request::is('professional/*')) active @endif">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Professional</span>
                                </div>
                            </a>
                        </li> --}}
                        ...
                        {{-- Partner --}}
                        {{-- <li class="nav-item">
                            <a href="{{ route('Partner.index') }}" class="group @if(Request::is('Partner') || Request::is('Partner/*')) active @endif">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Partner</span>
                                </div>
                            </a>
                        </li> --}}
